package com.hhx7.im.features.demo;
...
public abstract class DemoMessagesActivity extends AppCompatActivity
    ...
    protected void onStart() {
        ...
        List<Message> list=((App)getApplication()).getMessages();

        messagesAdapter.clear();
        if(list.size()>0)
            messagesAdapter.addToStart(list.get(list.size()-1), true);
    ...
    protected void loadMessages() {
        ...
        new Handler().postDelayed(new Runnable() { //imitation of internet connection
            ...
            public void run() {
                ...
                List<Message> messages = ((App)getApplication()).getMessages();
