package com.hhx7.im.data.fixtures;
...
public final class MessagesFixtures extends FixturesData {
    ...
    public static Message getImageMessage() {
        Message message = new Message(getRandomId(), getUser(),getUser(), null);
        message.setImage(new Picture(getRandomImage()));
        return message;
    }

    public static Message getVoiceMessage() {
        Message message = new Message(getRandomId(), getUser(),getUser(), null);
        message.setVoice(new Voice("http://example.com", rnd.nextInt(200) + 30));
        return message;
    }
    ...
    public static Message getTextMessage(String text) {
        return new Message(getRandomId(), getUser(),getUser(), text);
    }
